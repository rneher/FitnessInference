...
parser.add_argument('--gamma', default=3.0, type=float, help='scale factor for time scale, choose high (>2) for prediction, 0.5-1 for fitness inference')
...
prediction = sequence_ranking(seq_data, eps_branch_length=params.eps_branch, pseudo_count = 5,
                            methods = ['mean_fitness'], D=params.diffusion, distance_scale = params.gamma)
