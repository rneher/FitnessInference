...
if hostname in ['rneher-iMac', 'ag-neher-xps13']:
    fasttree_bin = '/ebio/ag-neher/share/programs/bin/fasttree_imac'
else:
    fasttree_bin = '/ebio/ag-neher/share/programs/bin/fasttree_cluster'
...
def plot_prediction_tree(prediction, method='mean_fitness', internal = False, axes = None, cb = True, offset=0.0001):
    '''
    ...
    ax = draw_tree(prediction.T, axes = axes, cb=cb)
